...
<div class="container">
 ...
 <div class="col-md-8">
 <div class="card">
 <div class="card-header">{{ __('Account REGSTRATION') }}</div>
 <div class="card-body">
...
@csrf
 ...
 <div class="col-md-6">
 <input id="department" type="text" class="formcontrol @error('department') isinvalid @enderror" name="department" value="{{ old('department') }}" required autocomplete="department" autofocus>
 @error('department')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
 </span>
